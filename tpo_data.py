...
def render_tpo_analysis():
    ...
    st.markdown(f"<h2 style='color: #FF9900; font-family: Outfit, sans-serif; border-bottom: 2px solid rgba(255, 153, 0, 0.4); padding-bottom:10px; text-transform: uppercase; letter-spacing: 1px;'>[VOLUME PROFILE / TPO: ELITE V3]</h2>", unsafe_allow_html=True)
