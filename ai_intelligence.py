...
def render_ai_intelligence():
    st.markdown(textwrap.dedent("""
        <h2 style='color: #FF9900; font-family: Outfit, sans-serif; border-bottom: 2px solid rgba(255, 153, 0, 0.4); padding-bottom:10px; text-transform: uppercase; letter-spacing: 1px;'>
            [AI MARKET INTELLIGENCE: ELITE V3]
        </h2>
