...
def render_market_data():
    st.markdown("<h2 style='color: #FF9900; font-family: Outfit, sans-serif; border-bottom: 2px solid rgba(255, 153, 0, 0.4); padding-bottom:10px; text-transform: uppercase; letter-spacing: 1px;'>[MARKETS MONITOR: ELITE V3]</h2>", unsafe_allow_html=True)
