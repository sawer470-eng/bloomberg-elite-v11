...
def render_correlation_matrix():
    st.markdown("<h2 style='color: #FF9900; font-family: Outfit, sans-serif; border-bottom: 2px solid rgba(255, 153, 0, 0.4); padding-bottom:10px; text-transform: uppercase; letter-spacing: 1px;'>[ASSET CORRELATION MATRIX: ELITE V3]</h2>", unsafe_allow_html=True)
    ...
    with st.spinner("Calculating full correlation matrix..."):
        try:
            ...
            # Calculation logic using the historical data
